...
// Desenhar cada opção do menu
for (var i = 0; i < op_max; i++) {
    var option_y = center_y + (margin * i);
    var option_text = opcoes[i];
    ...
    if (is_mouse_over_option(mouse_x, mouse_y, center_x, option_y, option_width, option_height) || index == i) {
        index = i;
    ...
    draw_text(center_x, option_y + 20, option_text);
}

// Desenhar texto adicional "sair"
draw_set_color(c_white);
draw_text(center_x, center_y - 70, sair);
